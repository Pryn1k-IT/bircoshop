...
$(document).on('click', '.menu-sm__btn', function(event) {
...
$(document).on('click', '.menu__list-click', function(event) {
	event.preventDefault();

	$('.menu__hide-1').toggleClass('active');
});


$(document).on('click', '.menu__list-sm', function(event) {
	event.preventDefault();

	$('.menu__hide-2').toggleClass('active');
});